    ...
    <section id="get-started" className="py-24 md:py-32 bg-primary relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <a
            href="#"
            className="group inline-flex items-center justify-center h-16 px-10 rounded-full bg-white text-primary font-bold text-lg hover:bg-cream transition-all hover:shadow-xl hover:shadow-black/10"
          >
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 text-white/70">
