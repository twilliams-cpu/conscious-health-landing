...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-cream/80 backdrop-blur-lg border-b border-sage-deep/50">
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#get-started"
            className="inline-flex items-center justify-center h-10 px-6 rounded-full bg-primary text-white text-sm font-semibold hover:bg-primary-light transition-colors"
          >
            Get Started
          </a>
        </div>
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="md:hidden bg-cream border-b border-sage-deep/50 overflow-hidden"
          >
